...
with tab_help:
    ...
    # Here is the MEL line as plain text
    st.text("MEL decision – Fix Now (add 20 min and $300) or Defer (0 min now, but there is a 40 % chance a compliance audit later fines you $1,000).")
